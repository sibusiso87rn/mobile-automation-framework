...
@Component
public class GenericUserActions {

    private static final Logger logger = LogManager.getLogger(GenericUserActions.class);
    ...
    private static WebDriver getDriver(){
        try {
            return ApplicationContext.getTestBean().getAppiumDriver();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
